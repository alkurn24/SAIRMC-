...
import { getBOMReport } from "../server/ReportsServerComm"
...
class ProductReportComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
    ...
    if (_this.state.plantList.length) {
      ...
      getBOMReport(params,
        function success(data) {
          ...
          let tempData = data.BomReport.map((prop, key) => {
            if (key === 0) {
  ...
  JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
    ...
    var fileName = ("Inventory Report_");
